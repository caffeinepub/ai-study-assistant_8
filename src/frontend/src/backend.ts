...
import type { ExamType as _ExamType, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addQuizAttempt(arg0: QuizAttempt): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addQuizAttempt(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllNotes(arg0: Principal): Promise<Array<Note>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllNotes(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllStudySessions(arg0: Principal): Promise<Array<StudySession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStudySessions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStats(arg0: Principal): Promise<{
        avgScore: bigint;
        notesCount: bigint;
        totalSessions: bigint;
        chatCount: bigint;
...
function from_candid_ExamType_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ExamType): ExamType {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        examType: from_candid_ExamType_n6(_uploadFile, _downloadFile, value.examType)
    };
}
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "jee" in value ? ExamType.jee : "neet" in value ? ExamType.neet : "upsc" in value ? ExamType.upsc : "class10" in value ? ExamType.class10 : "class12" in value ? ExamType.class12 : value;
}
...
function to_candid_ExamType_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ExamType): _ExamType {
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        subjects: value.subjects,
        name: value.name,
        examType: to_candid_ExamType_n12(_uploadFile, _downloadFile, value.examType)
    };
}
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ExamType): {
    jee: null;
} | {
    neet: null;
} | {
